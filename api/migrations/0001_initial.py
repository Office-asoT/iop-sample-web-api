    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setting', models.JSONField(blank=True, null=True, verbose_name='表示設定')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('user_id', 'farm_field_id'), name='unique_display_setting')],
            },
        ),
        migrations.CreateModel(
